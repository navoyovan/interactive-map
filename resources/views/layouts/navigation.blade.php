<nav x-data="{ open: false }" class="fixed top-0 left-0 w-full z-50 bg-white/50 backdrop-blur-sm ring-1 ring-white/20 shadow-md">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-800 bg-white/10 hover:text-gray-900 focus:outline-none transition-all duration-300 ease-in-out">
                            @auth
    ...
    <div :class="{'block pt-12': open, 'hidden': ! open}" class="hidden sm:hidden">
